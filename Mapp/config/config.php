...
|
*/
//$config['server_name']	= '52.74.238.215/CMS';
$config['server_name']	= 'localhost/M_CMS';
$config['document_root']	= $_SERVER['DOCUMENT_ROOT'];

//$config['document_root']	= '/var/www/html/CMS';


$config['base_url']	= 'http://'.$config['server_name'].'/';
$config['code_url']	= $config['document_root'];
